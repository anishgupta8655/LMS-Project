    ...
    <>
      ...
      <section className="p-6  dark:text-gray-900 bg-black text-white ">
        ...
        <form
          ...
          action=""
          method=""
          className="container flex flex-col mx-auto space-y-12 shadow-md pt-3 shadow-white"
        >
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              <div className="col-span-full sm:col-span-3">
                ...
                <input
                  ...
                  className="w-full text-white rounded-md focus:ring focus:ring-opacity-75 dark:text-white p-2 focus:dark:ring-violet-600 dark:border-gray-300"
                />
              </div>
              <div className="col-span-full sm:col-span-3">
                ...
                <input
                  ...
                  className="w-full text-white p-2 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300"
                />
              </div>
              <div className="col-span-full sm:col-span-3 ">
              ...
              <div className="col-span-full sm:col-span-3">
                ...
                <input
                  ...
                  type="number"
                  placeholder="Mobile"
                  className="w-full p-2  text-white rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300"
                />
              </div>
              ...
              <div className="col-span-full sm:col-span-3">
                ...
                <input
                  ...
                  accept=".jpeg, .jpg, .png"
                  className="w-full p-2 text-black rounded-md focus:ring focus:ring-opacity-75 dark:text-black focus:dark:ring-violet-600 border border-red-600"
                />
              </div>
              <div className="col-span-full sm:col-span-3">
                ...
                <input
                  ...
                  type="date"
                  placeholder=""
                  className="w-full p-2 bg-slate-300  rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-900 focus:dark:ring-violet-600 dark:border-gray-300"
                />
              </div>
              <div className="col-span-full sm:col-span-3">
                <label className="text-sm capitalize font-bold">
