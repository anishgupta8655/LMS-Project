...
const Signin = () => {
  ...
  return (
    <center className="p-6">
      <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-black text-white  dark:text-gray-800 shdow-md shadow-white">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50 text-white bg-violet-600"
          >
            Sign in
          </button>
        </form>
